...
var IntegrationHandler = Class.extend({

    init: function () {

    },

    postGitHook: function (req, res, parameters) {

//        console.log(parameters);
//        var payload = eval('(' + parameters.payload + ')');
        var payload = { "before": "5aef35982fb2d34e9d9d4502f6ede1072793222d",  "repository": {    "url": "http://github.com/defunkt/github",    "name": "github",    "description": "Youre lookin at it.",    "watchers": 5,    "forks": 2,    "private": 1,    "owner": {      "email": "chris@ozmm.org",      "name": "defunkt"    }  },  "commits": [
